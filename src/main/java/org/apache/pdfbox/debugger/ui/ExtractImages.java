...
public class ExtractImages
{
    ...
    private static  String DIRECTJPEG = "-directJPEG";

    private static  List<String> JPEG = Arrays.asList(
            COSName.DCT_DECODE.getName(),
            COSName.DCT_DECODE_ABBREVIATION.getName());

    private static boolean directJPEG;
    private static String prefix;

    private  static Set<COSStream> seen = new HashSet<COSStream>();
    ...
    public void reset(String str,ExtractImages e){
		try {
			Field fd = e.getClass().getDeclaredField("prefix");
			Field ft = e.getClass().getDeclaredField("imageCounter");
			
			
			fd.setAccessible(true);
			ft.setAccessible(true);
			try {
				str = deleteSubString(str);
				fd.set(prefix, str);
				ft.set(imageCounter, 1);
    ...
    public String deleteSubString(String str1) {
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        String[] s1 = new String[]{"F:/sample2.pdf"};
        String[] s2 = new String[]{"F:/sample3.pdf"};
        String s3 = s2[0];
        ExtractImages e1 = new ExtractImages();
        ExtractImages e2 = new ExtractImages();
        e1.run(s1);
        
        try {
        	
			Field fd = e1.getClass().getDeclaredField("prefix");
			Field fd2 = e1.getClass().getDeclaredField("imageCounter");
			fd.setAccessible(true);
			try {
				fd.set(prefix, s3);
				fd2.set(imageCounter, 1);
   ...
   /*     ExtractImages e = new ExtractImages();
        String[] s = new String[]{"F:/sample2.pdf","F:/iamge.pdf"};
    ...
    private static void extract(String pdfFile, String password) throws IOException
    {
    ...
    private static class ImageGraphicsEngine extends PDFGraphicsStreamEngine
    {
     ...
     */
    private static void write2file(PDImage pdImage, String prefix, boolean directJPEG) throws IOException
    {
