...
import org.apache.pdfbox.debugger.ui.BoxLayout;
...
import org.apache.pdfbox.debugger.ui.ExtractImages;
import org.apache.pdfbox.debugger.ui.ExtractOneImage;
import org.apache.pdfbox.debugger.ui.FileOpenSaveDialog;
import org.apache.pdfbox.debugger.ui.MapEntry;
import org.apache.pdfbox.debugger.ui.NumberTextField;
...
import org.apache.pdfbox.debugger.ui.SelectAll;
import org.apache.pdfbox.debugger.ui.SetKeyword;
import org.apache.pdfbox.debugger.ui.Tree;
import org.apache.pdfbox.debugger.ui.Utest;
import org.apache.pdfbox.debugger.ui.ZoomMenu;
import org.apache.pdfbox.debugger.ui.Stripperall;
import org.apache.pdfbox.debugger.ui.Stripperone;
import org.apache.pdfbox.debugger.ui.Testsave;
...
public class PDFDebugger extends JFrame
{
   ...
   public static JCheckBoxMenuItem allowSubsampling;
    ...
    private JMenu createFileMenu()
    {
        ...
        JMenuItem openUrlMenuItem = new JMenuItem("pdf属性");
        ...
        openUrlMenuItem.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent evt)
            {
            	new BoxLayout(currentFilePath);
            	
            }
        });
        fileMenu.add(openUrlMenuItem);
        
        reopenMenuItem = new JMenuItem("刷新");
        ...
        recentFilesMenu = new JMenu("最近文件");
   ...
   //   fileMenu.add(printMenuItem);
        ...
        exitMenuItem.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent evt)
            {
            	int result = JOptionPane.showConfirmDialog(null,"确定要退出吗？","退出提示",0);
            	if(result == 0)
    ...
    private JMenu createEditMenu()
    {
        ...
        JMenu txtStripper = new JMenu("提取文字");
        
        JMenuItem cutMenuItem = new JMenuItem("全部提取");
        cutMenuItem.setAccelerator(KeyStroke.getKeyStroke("alt S"));
        ...
        cutMenuItem.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent evt)
            {
            	try
                {
                    new Stripperall();
                    new Testsave();
                    Testsave.saveFile(Stripperall.getTextFromPDF(currentFilePath));
        ...
        txtStripper.add(cutMenuItem);
        txtStripper.addSeparator();
        
        JMenuItem sMenuItem = new JMenuItem("自定义提取");
        ...
        sMenuItem.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent evt)
            {
                ...
                {
                    new Stripperone();
                    Stripperone.Stripper(currentFilePath);
        ...
        txtStripper.add(sMenuItem);
        
        editMenu.add(txtStripper);
        editMenu.addSeparator();
    //    editMenu.add(cutMenuItem);

        
        JMenu imageStripper = new JMenu("提取图片");
        JMenuItem copyMenuItem = new JMenuItem("全部提取");
        copyMenuItem.setAccelerator(KeyStroke.getKeyStroke("alt I"));
        ...
        copyMenuItem.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent evt)
            {
               try
                {
            	   new ExtractImages();
            	   String[] s = new String[]{currentFilePath};
            	   ExtractImages.run(s);
        ...
        imageStripper.add(copyMenuItem);
        imageStripper.addSeparator();
        
        JMenuItem oneStripper = new JMenuItem("自定义提取");
        oneStripper.setEnabled(true);
        oneStripper.addActionListener(new ActionListener()
        {
            @Override
            public void actionPerformed(ActionEvent evt)
            {
            	try
                {
                    ...
                    str[0] = currentFilePath;
                    ExtractOneImage.Stripper(str);
        ...
        imageStripper.add(oneStripper);
        imageStripper.addSeparator();
        
        JMenuItem allStripper = new JMenuItem("批量提取");
        allStripper.setEnabled(true);
        allStripper.addActionListener(new ActionListener()
        {
            @Override
            public void actionPerformed(ActionEvent evt)
            {
        ...
        imageStripper.add(allStripper);        
        editMenu.add(imageStripper);

        JMenuItem pasteMenuItem = new JMenuItem("提取关键词");
        pasteMenuItem.setAccelerator(KeyStroke.getKeyStroke("alt K"));
        ...
        pasteMenuItem.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent evt)
            {
			   ...
			   new Stripperall();
               String str = Stripperall.getTextFromPDF(currentFilePath);
               str = str.replaceAll("\\s", "");
			   new TFIDFAnalyzer();
			   wl = TFIDFAnalyzer.run(str);
          ...
          //     JButton button1=new JButton("生成标签");
          /*     button1.addActionListener(new ActionListener()
            ...
            */  
            final JTextField jt = new JTextField(sss,20);
            jt.setFont(new Font("汉真广标", Font.PLAIN, 16));
            panel.add(jt);
              
            
               
               JButton button2=new JButton("写入标签");
               ...
               button2.addActionListener(new ActionListener()
               {
                   ...
                   public void actionPerformed(ActionEvent evt)
                   {
       				  final String ifo = jt.getText();
                      new SetKeyword(currentFilePath,ifo);	
                      JOptionPane.showMessageDialog(panel,"关键词已写入","提示",1);
                   }   
               });    
            ...
            //   panel.add(button1);
             ...
             // jp.add(table);
               ...
               tableModel.setColumnIdentifiers(new Object[]{"关键词","TF-IDF值"});//设置表头
            
               for(int i = 1; i < 11; i = i+2){
            	  
            	  tableModel.addRow(new Object[]{wl[i],wl[i+1]});
               }
    ...
    private void readPDFFile(final File file, String password) throws IOException
    {
        ...
        {
            setTitle("PDF tool - " + file.getAbsolutePath());
        }
        addRecentFileItems();
    }
